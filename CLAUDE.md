...
```
slack_fetch/
├── mcp_server.py      # MCP Tools (8개): list_channels, list_users, crawl_channel,
│                      #   crawl_user, search_messages, crawl_threads, crawl_mentions,
│                      #   get_collected_data
├── config.py          # CrawlerConfig — SLACK_USER_TOKEN만 필수
├── client.py          # WebClient 팩토리
├── channels.py        # 채널 목록 수집 (public/private/DM)
├── messages.py        # 메시지 수집 — collect_user_history + collect_channel_history
